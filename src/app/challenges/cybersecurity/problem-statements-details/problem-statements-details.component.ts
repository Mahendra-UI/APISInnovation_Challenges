...
@Component({
  selector: 'app-problem-statements-details',
  templateUrl: './problem-statements-details.component.html',
  styleUrls: ['./problem-statements-details.component.css']
})
export class ProblemStatementsDetailsComponent implements OnInit {
  statementId: any;
  object:any = [
    {
      id: 0,
